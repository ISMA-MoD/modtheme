...
<div id="page" class="hfeed site">
	<a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'mod' ); ?></a>
	...
	<header id="masthead" class="site-header" role="banner">
		<div class="persistent">
			...
			<nav id="site-navigation" class="main-navigation" role="navigation">
				<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php _e( 'Menu', 'mod' ); ?></button>
